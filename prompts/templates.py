# taken from https://github.com/bigscience-workshop/promptsource/blob/main/promptsource/templates.py
...
class Template(yaml.YAMLObject):
    ...
    def __init__(self, name, jinja, author, metadata=None, answer_choices=None):
        """
...
def get_templates_data_frame():
    ...
    for key in template_collection.keys:
        ...
        for template_name in templates.all_template_names:
            ...
            data["author"].append(template.get_author())
